...
import { useGetOrdersByEmailIdQuery } from '../../redux/features/orders/ordersAPI';
import { useParams } from 'react-router-dom';

const OrderPage = () => {
    const { currentUser } = useAuth()
    const { data: orders = [], isLoading, isError } = useGetOrdersByEmailIdQuery(currentUser.email)
